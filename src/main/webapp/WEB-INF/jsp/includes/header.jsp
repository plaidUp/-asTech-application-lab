...
<html>
    <head>
        ...
        <%--&lt;%&ndash;BOOTSWATCH&ndash;%&gt;--%>
        <%--<c:url value="/static/css/bootswatch_lux.css" var="lux" />--%>
            <%--<link href="${lux}" rel="stylesheet" media="screen" />--%>
        ...
        <%--CUSOTM CSS--%>
        <c:url value="/static/css/vehicle.css" var="bootstrapCUSTOM" />
            <link href="${bootstrapCUSTOM}" rel="stylesheet" media="screen" >

        <meta name="viewport" content="width=device-width">
        <title>Vehicle Editing Application</title>
    </head>
</html>